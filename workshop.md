...
One other helpful method is `with_row_index`. This adds a column to the start of your dataframe indexing the rows. You can use `offset` to specify the start index.
