...
This Python environment has been created for you. Have a look at [Environment](/docs/environment.md) if you want to learn how to set up a Python environment from scratch.
