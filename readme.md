...
- `2024_candidates` - A table of the election results with one row per candidate
- `2019_winning_parties` - A table showing which party won each constituency at the previous election in 2019
